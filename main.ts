...
if (pin.userPin === myPin) {
  ...
  if (options.operations === "Withdraw Cash") {
    ...
    if (withDraw.cashWithdraw === "1000") {
      console.log(
        `Successfull withdrawal, Your new balance is "${myBalance - 1000}"`
      );
    } else if (withDraw.cashWithdraw === "5000") {
      console.log(
        `Successfull withdrawal, Your new balance is "${myBalance - 5000}"`
      );
    } else if (withDraw.cashWithdraw === "10000") {
      console.log(
        `Successfull withdrawal, Your new balance is "${myBalance - 10000}"`
      );
    } else if (withDraw.cashWithdraw === "15000") {
      console.log(
        `Successfull withdrawal, Your new balance is "${myBalance - 15000}"`
      );
      ...
      if (customAmount.customOption > myBalance) {
        ...
        console.log(
          `Successfull withdrawal, Your new balance is "${
            myBalance - customAmount.customOption
          }"`
        );
      }
    }
